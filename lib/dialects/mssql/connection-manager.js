...
ConnectionManager.prototype.connect = function(config) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (config.dialectOptions) {
      ...
      if(connectionConfig.options.domain) {
        // Move the domain property up and out of the "options" subkey
        connectionConfig.domain = connectionConfig.options.domain;
        delete connectionConfig.options.domain;
      }
    }
